  ...
  return (
    <li>
      <Link
        ...
        className={`cursor-pointer hover:text-white text-primary px-5 py-2 rounded-md block text-sm font-medium duration-200 hover:bg-primary  border border-primary ${
