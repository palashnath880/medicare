...
//           {slides_data.map(
//             (
//               { bgImg, image, name, degree, currentEmployeeOf, specialist },
//               index
//             ) => (
//               <div
//                 data-index={index}
//                 key={index}
//                 className="absolute top-0 left-0 w-full h-full bg-center bg-no-repeat bg-cover duration-500 group opacity-0 -z-10"
...
//                               {name}
//                             </h3>
//                             <p className="text-white text-opacity-90 text-sm mt-2 duration-1000 translate-y-full opacity-0 group-[.active]:translate-y-0 group-[.active]:opacity-100">
//                               {degree}
//                             </p>
//                           </div>
//                           <p className="text-white duration-1000 translate-y-full opacity-0 group-[.active]:translate-y-0 group-[.active]:opacity-100">
...
//             <button
//               ref={prevRef}
//               className="absolute top-1/2 -translate-y-1/2 text-white left-0 opacity-80 hover:opacity-100 duration-200"
//             >
//               <BiSolidLeftArrow className="w-9 h-9" />
//             </button>
//             <button
//               ref={nextRef}
//               className="absolute top-1/2 -translate-y-1/2 text-white right-0 opacity-80 hover:opacity-100 duration-200"
//             >
