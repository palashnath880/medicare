                ...
                <div className='mt-16'>
                    <div className='grid grid-cols-4 gap-5'>
                        {doctors.map(({ name, currentEmployeeOf, degree, image, specialist }, index) => <div key={index} className='pt-10'>
                            <div className='bg-primary bg-opacity-10 rounded-xl shadow-lg relative pt-10'>
                                ...
                                <div className='flex gap-0.5 border-t border-primary rounded-b-xl overflow-hidden'>
                                    ...
                                    <button className='text-sm font-medium w-1/2 text-center py-3 text-white bg-primary'>Visit Times</button>
                                </div>
                            </div>
                        </div>)}
                    </div>
